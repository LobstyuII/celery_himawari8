...
def download_himawari_l2arp(date, hour):
    logger.info(f"开始下载Himawari-8 L2ARP数据 for {date} {hour}:00 UTC")
    ftp_path = f"/pub/himawari/L2/ARP/030/{date.year:04d}{date.month:02d}/{date.day:02d}/{hour:02d}/NC_H08_{date.year:04d}{date.month:02d}{date.day:02d}_{hour:02d}00_L2ARP030_FLDK.02401_02401.nc"
